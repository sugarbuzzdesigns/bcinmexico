...
<footer>
	...
	<?php if (get_theme_mod( 'footer_logo_upload', get_template_directory_uri() . '/images/Meet-Me-In-Mexico-Logo.png' )) : ?>
	<h1 id="logo-footer"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo get_theme_mod( 'footer_logo_upload', get_template_directory_uri() . '/images/Meet-Me-In-Mexico-Logo.png' ); ?>" alt="<?php bloginfo('name'); ?>" width="300" /></a></h1>
	<?php endif; ?>
